...
class Class:
    # object:基类，所有类继承基类，里面定义很多魔法方法，例如：__init__()实例方法，__del__析构函数
    cla_name = "类属性"
...
# print(ai2.cls_room,Class,cls_name)  # 实例属性，类不能访问，只有这个实例对象可以访问
# 访问保护属性，私有属性
# print(ai2._job,Class_job)  # 保护属性如果和公有属性对象对象可以访问，类不能访问
# print(ai2.__hobby,Class__hobby)  # 私有属性，只能类内访问
# 可以通过类内定义的实例方法访问
